    ...
    <>
      <div className="product-list-container">
        ...
        <div className="product-grid">
          <h1 className="text-2xl font-bold mb-4">{products.category_name}</h1>
...
//   // ฟังก์ชันดึงข้อมูลจาก API
//   useEffect(() => {
//     fetch("http://localhost:3000/api/products-and-categories") // เชื่อมต่อ API backend
//       .then((response) => response.json())
//       .then((data) => {
//         setProducts(data.products);
//         setCategories(data.categories);
//       })
//       .catch((error) => console.error("Error fetching products and categories:", error));
//   }, []);

//   // ฟังก์ชันกรองสินค้าโดยหมวดหมู่
