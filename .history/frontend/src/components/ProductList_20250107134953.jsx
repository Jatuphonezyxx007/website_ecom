...
const ProductList = () => {
  ...
  // ฟังก์ชันสำหรับการคลิกที่การ์ดสินค้า
  const handleCardClick = (productId) => {
    // ส่งผู้ใช้ไปที่หน้า productdetail พร้อมกับส่ง id ของสินค้าใน URL
            ...
            {products
              ...
              .map((product) => (
                <Card
                  ...
                  isPressable
                  shadow="sm"
                  onPress={() => handleCardClick(product.id)} // เรียกใช้ handleCardClick
                  className="product-card"
                >
                  <CardBody className="overflow-hidden p-0">
                    <Image
