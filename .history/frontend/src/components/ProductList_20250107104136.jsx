              ...
              >
                ...
                <CardFooter className="text-small justify-between p-4">
                  <div className="product-details">
                    ...
                    <p className="product-price">฿{product.price.toLocaleString()}</p> {/* การแสดงราคาพร้อมเครื่องหมายคอมมา */}
                    <p className="product-category">{product.category_name}</p>
                    </div>
                    <div className="product-status">
                      <p className={`status-badge ${product.status === "in_stock" ? "in-stock" : "out-of-stock"}`} > {product.status === "in_stock" ? "In Stock" : "Out of Stock"} </p>
                      </div>
                      </CardFooter>
              </Card>
            ))}
