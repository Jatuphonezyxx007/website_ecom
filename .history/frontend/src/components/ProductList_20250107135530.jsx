...
import React, { useEffect, useState } from "react";
import { Card, CardBody, CardFooter, Image, Input } from "@nextui-org/react";
import { useHistory } from 'react-router-dom'; // นำเข้า useHistory สำหรับการนำทาง
import './ProductList.css'; // นำเข้าไฟล์ CSS
...
const ProductList = () => {
  const [products, setProducts] = useState([]);
  const [searchQuery, setSearchQuery] = useState("");
  const history = useHistory(); // ใช้ history ในการนำทาง
  ...
  const handleCardClick = (productId) => {
    // เมื่อคลิกที่สินค้า ให้ไปที่หน้า productdetail พร้อมกับส่ง id สินค้าไป
