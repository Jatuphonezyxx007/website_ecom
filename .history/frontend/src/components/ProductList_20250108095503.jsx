...
const ProductList = () => {
  ...
  const [itemsPerPage] = useState(6); // จำนวนสินค้าต่อหน้า
  ...
  const handleSearchChange = (e) => {
    setSearchQuery(e.target.value);
    setCurrentPage(1); // รีเซ็ตไปที่หน้าแรกเมื่อมีการค้นหา
  };
              ...
              paginatedProducts.map((product) => (
                ...
                >
                  <CardBody className="overflow-hidden p-0">
                    <Image
                      alt={product.name}
                      src={product.image_path || "https://via.placeholder.com/500x500"}
                      width="100%"
                      height="100%"
                      radius="lg"
                    />
